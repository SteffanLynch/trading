...
A lot is the size of your trade. It determines how much you make or lose per pip.
...
1. Decide how much of your account you're willing to risk (e.g., 1%)
2. Measure your stop loss distance in pips
3. Calculate the lot size that makes your stop loss equal to 1% of your account

**Example:**
- Account: $10,000
- Risk per trade: 1% = $100
- Stop loss: 50 pips
- Position size: $100 ÷ 50 pips = $2 per pip = 0.2 lots (2 mini lots)
